...
double Stinky_vstAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int Stinky_vstAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void Stinky_vstAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void Stinky_vstAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool Stinky_vstAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void Stinky_vstAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
void Stinky_vstAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void Stinky_vstAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
